...
* Mardi 26/07
 ...
 Générer un nom d'expérience approprié / briser les dépendances
* Mercredi 27/07
  Modification script Execo : si une expérience foire, le reste est
  quand même testé

  Les résultats contiennent désormais les révisions dans leur nom,
  ex : =experiment_monexperience_c1234_s454=

  Chaque expérience est maintenant placée dans un répertoire qui lui
  est propre : =monexperience_c1234_s454/=

  Problème d'installation avec Spack (?) -> 3x le même -> très très bizarre

  Maintenant ça marche (je n'ai rien changé) -> WTF

  Piste : problème de checksum (il n'y en a pas pour les révisions) ?
* Jeudi 28/07
  Modification du script récupérant l'ensemble des données (celles-ci
  étaient placées dans des répertoires qui leur sont propres)
  
  Ajout de la commande exécutée dans le fichier CSV

  Modification du fichier CSV : si une case est identique à celle d'au
  dessus, on peut la laisser vide -> allège le CSV (les commandes sont
  très grosses) -> refonte du module CSVHeader (devient CSVReader)

  Création du script générant les org-files

  Erreur de checksum :
  #+begin_example
  [in] ==> Warning: There is no checksum on file to fetch starpu@svn_1_18010 safely.
  [in] ==> Error: Will not fetch starpu@svn_1_18010
  [in] ==> Error: Installation process had nonzero exit code.
  #+end_example

  Arnaud : placer les commandes dans un autre fichier
* Vendredi 29/07
  3 fichiers CSV + nouveau script python créant un CSV final

  Modification des anciens scripts existant

  Une expérience est caractérisée par :
  - son nom
  - sa branche (nom abstrait) et révision chameleon
  - sa branche (nom abstrait) et révision starpu
  - la commande exécutée (nom abstrait)

  Les fichiers et dossiers des résultats comprendront ces informations

  -> écriture du générateur de org files
 
  -> écriture du parseur de org files pour rassembler tous les résultats

  Toujours cette erreur :
  #+begin_example
  [ 75%] Building C object compute/CMakeFiles/chameleon.dir/control/workspace_z.c.o
  cd /tmp/root/spack-stage/spack-stage-bliB4d/chameleon/spack-build/compute && /root/kameleon_workdir/debian_g5k/spack/lib/spack/env/gcc/gcc  -DADD_ -DCHAMELEON_SCHED_STARPU -DCHAMELEON_USE_S$
  [ 75%] Building C object compute/CMakeFiles/chameleon.dir/control/workspace_d.c.o
  cd /tmp/root/spack-stage/spack-stage-bliB4d/chameleon/spack-build/compute && /root/kameleon_workdir/debian_g5k/spack/lib/spack/env/gcc/gcc  -DADD_ -DCHAMELEON_SCHED_STARPU -DCHAMELEON_USE_S$
  [ 75%] Building C object compute/CMakeFiles/chameleon.dir/control/morse_cf77.c.o
  cd /tmp/root/spack-stage/spack-stage-bliB4d/chameleon/spack-build/compute && /root/kameleon_workdir/debian_g5k/spack/lib/spack/env/gcc/gcc  -DADD_ -DCHAMELEON_SCHED_STARPU -DCHAMELEON_USE_S$
  [ 75%] Building C object compute/CMakeFiles/chameleon.dir/control/morse_sf77.c.o
  cd /tmp/root/spack-stage/spack-stage-bliB4d/chameleon/spack-build/compute && /root/kameleon_workdir/debian_g5k/spack/lib/spack/env/gcc/gcc  -DADD_ -DCHAMELEON_SCHED_STARPU -DCHAMELEON_USE_S$
  [ 75%] Building C object compute/CMakeFiles/chameleon.dir/control/morse_zf77.c.o
  cd /tmp/root/spack-stage/spack-stage-bliB4d/chameleon/spack-build/compute && /root/kameleon_workdir/debian_g5k/spack/lib/spack/env/gcc/gcc  -DADD_ -DCHAMELEON_SCHED_STARPU -DCHAMELEON_USE_S$
  [ 75%] Building C object compute/CMakeFiles/chameleon.dir/control/morse_df77.c.o
  cd /tmp/root/spack-stage/spack-stage-bliB4d/chameleon/spack-build/compute && /root/kameleon_workdir/debian_g5k/spack/lib/spack/env/gcc/gcc  -DADD_ -DCHAMELEON_SCHED_STARPU -DCHAMELEON_USE_S$
  [ 75%] Linking Fortran shared library libchameleon.so
  cd /tmp/root/spack-stage/spack-stage-bliB4d/chameleon/spack-build/compute && /root/kameleon_workdir/debian_g5k/spack/opt/spack/linux-x86_64/gcc-4.7/cmake-3.5.2-n2l2v7fdb2epujz6fsuaeovwhde6a$
  /root/kameleon_workdir/debian_g5k/spack/lib/spack/env/gcc/gfortran  -fPIC -O2 -g -DNDEBUG  -lgfortran -shared -Wl,-soname,libchameleon.so -o libchameleon.so CMakeFiles/chameleon.dir/__/cont$
  make[2]: Leaving directory `/tmp/root/spack-stage/spack-stage-bliB4d/chameleon/spack-build'
  [ 75%] Built target chameleon
  make[1]: Leaving directory `/tmp/root/spack-stage/spack-stage-bliB4d/chameleon/spack-build'
  make: *** [all] Error 2
  ...
  ==> Installing hwloc
  ==> Installing cmake
  ==> Installing netlib-cblas
  ==> cmake is already installed in /root/kameleon_workdir/debian_g5k/spack/opt/spack/linux-x86_64/gcc-4.7/cmake-3.5.2-n2l2v7fdb2epujz6fsuaeovwhde6a7ya
  ==> Installing openblas
  ==> fxt is already installed in /root/kameleon_workdir/debian_g5k/spack/opt/spack/linux-x86_64/gcc-4.7/fxt-0.3.1-pcesmbkenyhpewy2qgb6cv6hayywn7nh
  ==> Installing netlib-lapacke
  ==> Installing netlib-lapack
  ==> cmake is already installed in /root/kameleon_workdir/debian_g5k/spack/opt/spack/linux-x86_64/gcc-4.7/cmake-3.5.2-n2l2v7fdb2epujz6fsuaeovwhde6a7ya
  ==> openblas is already installed in /root/kameleon_workdir/debian_g5k/spack/opt/spack/linux-x86_64/gcc-4.7/openblas-0.2.18-hw3iztftqu5o4rktfsccogprb4hcsnxf
  ==> cmake is already installed in /root/kameleon_workdir/debian_g5k/spack/opt/spack/linux-x86_64/gcc-4.7/cmake-3.5.2-n2l2v7fdb2epujz6fsuaeovwhde6a7ya
  ==> openblas is already installed in /root/kameleon_workdir/debian_g5k/spack/opt/spack/linux-x86_64/gcc-4.7/openblas-0.2.18-hw3iztftqu5o4rktfsccogprb4hcsnxf
  ==> netlib-lapack is already installed in /root/kameleon_workdir/debian_g5k/spack/opt/spack/linux-x86_64/gcc-4.7/netlib-lapack-3.6.0-d7tlkka2srptm2g4l43zkwiw6hcqhqsl
  ==> openblas is already installed in /root/kameleon_workdir/debian_g5k/spack/opt/spack/linux-x86_64/gcc-4.7/openblas-0.2.18-hw3iztftqu5o4rktfsccogprb4hcsnxf
  ==> Trying to check out svn repository: https://scm.gforge.inria.fr/anonscm/svn/morse/trunk/chameleon
  ==> No checksum needed when fetching with svn
  ==> Already staged chameleon-svn_1_trunk_2920_cmd1-wqe2k6nndxzwzovrbcbburrc2zsgbkha in /root/kameleon_workdir/debian_g5k/spack/var/spack/stage/chameleon-svn_1_trunk_2920_cmd1-wqe2k6nndxzwzo$
  ==> No patches needed for chameleon
 ==> Building chameleon
  #+end_example

** A faire
   - Prendre en compte les potentielles erreurs
   - Mettre des noms devant les expériences devant data.csv ?
* Lundi 01/08
  Correction de quelques bugs

  Le bug Spack n'est toujours pas résolu ! -> utilisation du flag =-d=
  (--debug) dans Spack :

  #+begin_example
  [in] ==> openblas is already installed in /root/kameleon_workdir/debian_g5k/spack/opt/spack/linux-x86_64/gcc-4.7/openblas-0.2.18-hw3iztftqu5o4rktfsccogprb4hcsnxf
  [in] 
  [in] stderr:
  [in] ==> '/usr/bin/g++-4.7' '-dumpversion'
  [in] ==> '/usr/bin/gfortran-4.7' '-dumpversion'
  [in] ==> '/usr/bin/gfortran' '-dumpversion'
  [in] ==> '/usr/bin/gfortran' '-dumpversion'
  [in] ==> '/usr/bin/g++' '-dumpversion'
  [in] ==> '/usr/bin/gfortran-4.7' '-dumpversion'
  [in] ==> '/usr/bin/gfortran' '-dumpversion'
  [in] ==> '/usr/bin/gfortran' '-dumpversion'
  [in] ==> '/usr/bin/gfortran-4.7' '-dumpversion'
  ...
  [in] ==> '/usr/bin/g++-4.7' '-dumpversion'
  [in] ==> '/usr/bin/gfortran-4.7' '-dumpversion'
  [in] ==> '/usr/bin/gcc-4.6' '-dumpversion'
  [in] ==> '/usr/bin/gcc-4.7' '-dumpversion'
  [in] ==> '/usr/bin/gcc-4.7' '-dumpversion'
  [in] ==> '/usr/bin/gcc' '-dumpversion'
  [in] ==> '/usr/bin/gcc-4.7' '-dumpversion'
  [in] ==> '/usr/bin/gcc-4.7' '-dumpversion'
  [in] ==> '/usr/bin/gcc-4.6' '-dumpversion'
  [in] ==> '/usr/bin/gcc' '-dumpversion'
  ...
  [in] ==> '/usr/bin/gcc-4.6' '-dumpversion'
  [in] ==> '/usr/bin/gcc-4.6' '-dumpversion'
  [in] ==> '/usr/bin/ibv_devices'
  [in] ==> '/usr/bin/curl' '-C' '-' '-o' '/root/kameleon_workdir/debian_g5k/spack/var/spack/stage/fxt-0.3.1-pcesmbkenyhpewy2qgb6cv6hayywn7nh/fxt-0.3.1.tar.gz.part' '-f' '-D' '-' '-L' 'http://download.savannah.gnu.org/releases/fkt/fxt-0.3.1.tar.gz' '-sS'
  [in] ==> '/bin/tar' '-xf' '/root/kameleon_workdir/debian_g5k/spack/var/spack/stage/fxt-0.3.1-pcesmbkenyhpewy2qgb6cv6hayywn7nh/fxt-0.3.1.tar.gz'
  [in] ==> Installing /tmp/root/spack-stage/spack-stage-SursRl/fxt-0.3.1/spack-build.out to /root/kameleon_workdir/debian_g5k/spack/opt/spack/linux-x86_64/gcc-4.7/fxt-0.3.1-pcesmbkenyhpewy2qgb6cv6hayywn7nh/.spack/build.out
  [in] ==> Installing /tmp/root/spack-stag
  [in] [...]
  [in] eon_workdir/debian_g5k/spack/opt/spack/linux-x86_64/gcc-4.7/openblas-0.2.18-hw3iztftqu5o4rktfsccogprb4hcsnxf/.spack/repos/builtin/packages/openblas to /root/kameleon_workdir/debian_g5k/spack/opt/spack/linux-x86_64/gcc-4.7/netlib-lapacke-3.6.0-x6tvxiygun7luxahguabnj6amcg7auzo/.spack/repos/builtin/packages/openblas
  [in] ==> 	WRITE : netlib-lapacke@3.6.0%gcc@4.7+shared arch=linux-x86_64-x6tvxiy [/root/kameleon_workdir/debian_g5k/spack/share/spack/modules/linux-x86_64/netlib-lapacke-3.6.0-gcc-4.7-x6tvxiygun7luxahguabnj6amcg7auzo]
  [in] ==> 	WRITE : netlib-lapacke@3.6.0%gcc@4.7+shared arch=linux-x86_64-x6tvxiy [/root/kameleon_workdir/debian_g5k/spack/share/spack/dotkit/linux-x86_64/netlib-lapacke-3.6.0-gcc-4.7-x6tvxiygun7luxahguabnj6amcg7auzo.dk]
  [in] ==> '/usr/bin/svn' 'checkout' '--force' '-r' '2920' 'https://scm.gforge.inria.fr/anonscm/svn/morse/trunk/chameleon'
  [in] Traceback (most recent call last):
  [in]   File "/root/kameleon_workdir/debian_g5k/spack/lib/spack/spack/build_environment.py", line 406, in fork
  [in]     function()
  [in]   File "/root/kameleon_workdir/debian_g5k/spack/lib/spack/spack/package.py", line 1022, in build_process
  [in]     raise e
  [in] spack.util.executable.ProcessError: Command exited with status 2:
  [in]     'make' '-j8'
  [in] Traceback (most recent call last):
  [in]   File "/root/kameleon_workdir/execo_recipe/../debian_g5k/spack//bin/spack", line 154, in main
  [in]     return_val = command(parser, args)
  [in]   File "/root/kameleon_workdir/debian_g5k/spack/lib/spack/spack/cmd/install.py", line 82, in install
  [in]     explicit=True)
  [in]   File "/root/kameleon_workdir/debian_g5k/spack/lib/spack/spack/package.py", line 1055, in do_install
  [in]     spack.build_environment.fork(self, build_process)
  [in]   File "/root/kameleon_workdir/debian_g5k/spack/lib/spack/spack/build_environment.py", line 427, in fork
  [in]     raise InstallError("Installation process had nonzero exit code.".format(str(returncode)))
  [in] spack.build_environment.InstallError: Installation process had nonzero exit code.
  #+end_example

  Problème dur : envoie d'un mail à Florent
  
  Début du rapport de stage
* Mardi 02/08
  Pas de réponse de Florent (sûrement en vacances)

  Continuation du rapport de stage

  Ecriture d'un bilan de production (à l'intention du futur
  developpeur qui prendra ma place)
* Vendredi 05/08
  Dans le package starPU : la spec =+fxt= et la spec =svn-trunk= sont
  liées -> adaptation pour fonctionner avec nos révisions

  Pas suffisant pour résoudre le problème

  Retirer la compilation parallèle de Chameleon -> semble fonctionner !
