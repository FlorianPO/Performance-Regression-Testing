...
function post_exec_wrapper {
    ...
    # Print end flags
    echo -n __CMD_ERR_29_29562_102639_END__ 1>&2
    echo -n __CMD_OUT_29_29562_102639_END__
}

function pre_exec_wrapper {
    # Print begin flags
    echo -n __CMD_ERR_29_29562_102639_BEGIN__ 1>&2
    echo -n __CMD_OUT_29_29562_102639_BEGIN__
}
