...
function post_exec_wrapper {
    ...
    # Print end flags
    echo -n __CMD_ERR_35_9792_76297_END__ 1>&2
    echo -n __CMD_OUT_35_9792_76297_END__
}

function pre_exec_wrapper {
    # Print begin flags
    echo -n __CMD_ERR_35_9792_76297_BEGIN__ 1>&2
    echo -n __CMD_OUT_35_9792_76297_BEGIN__
}
