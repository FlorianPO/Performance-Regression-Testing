...
function post_exec_wrapper {
    ...
    # Print end flags
    echo -n __CMD_ERR_51_9874_442112_END__ 1>&2
    echo -n __CMD_OUT_51_9874_442112_END__
}

function pre_exec_wrapper {
    # Print begin flags
    echo -n __CMD_ERR_51_9874_442112_BEGIN__ 1>&2
    echo -n __CMD_OUT_51_9874_442112_BEGIN__
}
