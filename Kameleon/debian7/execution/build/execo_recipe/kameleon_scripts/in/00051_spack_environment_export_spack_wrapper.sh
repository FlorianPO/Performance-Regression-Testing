...
function post_exec_wrapper {
    ...
    # Print end flags
    echo -n __CMD_ERR_51_4161_48799_END__ 1>&2
    echo -n __CMD_OUT_51_4161_48799_END__
}

function pre_exec_wrapper {
    # Print begin flags
    echo -n __CMD_ERR_51_4161_48799_BEGIN__ 1>&2
    echo -n __CMD_OUT_51_4161_48799_BEGIN__
}
