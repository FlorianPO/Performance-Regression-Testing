...
function post_exec_wrapper {
    ...
    # Print end flags
    echo -n __CMD_ERR_53_7402_525299_END__ 1>&2
    echo -n __CMD_OUT_53_7402_525299_END__
}

function pre_exec_wrapper {
    # Print begin flags
    echo -n __CMD_ERR_53_7402_525299_BEGIN__ 1>&2
    echo -n __CMD_OUT_53_7402_525299_BEGIN__
}
