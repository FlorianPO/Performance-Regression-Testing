...
function post_exec_wrapper {
    ...
    # Print end flags
    echo -n __CMD_ERR_61_7402_185795_END__ 1>&2
    echo -n __CMD_OUT_61_7402_185795_END__
}

function pre_exec_wrapper {
    # Print begin flags
    echo -n __CMD_ERR_61_7402_185795_BEGIN__ 1>&2
    echo -n __CMD_OUT_61_7402_185795_BEGIN__
}
