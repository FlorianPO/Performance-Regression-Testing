...
function post_exec_wrapper {
    ...
    # Print end flags
    echo -n __CMD_ERR_53_9874_161989_END__ 1>&2
    echo -n __CMD_OUT_53_9874_161989_END__
}

function pre_exec_wrapper {
    # Print begin flags
    echo -n __CMD_ERR_53_9874_161989_BEGIN__ 1>&2
    echo -n __CMD_OUT_53_9874_161989_BEGIN__
}
