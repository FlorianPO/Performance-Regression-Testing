...
function post_exec_wrapper {
    ...
    # Print end flags
    echo -n __CMD_ERR_53_4161_100405_END__ 1>&2
    echo -n __CMD_OUT_53_4161_100405_END__
}

function pre_exec_wrapper {
    # Print begin flags
    echo -n __CMD_ERR_53_4161_100405_BEGIN__ 1>&2
    echo -n __CMD_OUT_53_4161_100405_BEGIN__
}
