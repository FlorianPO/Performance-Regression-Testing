...
function post_exec_wrapper {
    ...
    # Print end flags
    echo -n __CMD_ERR_49_9874_191352_END__ 1>&2
    echo -n __CMD_OUT_49_9874_191352_END__
}

function pre_exec_wrapper {
    # Print begin flags
    echo -n __CMD_ERR_49_9874_191352_BEGIN__ 1>&2
    echo -n __CMD_OUT_49_9874_191352_BEGIN__
}
