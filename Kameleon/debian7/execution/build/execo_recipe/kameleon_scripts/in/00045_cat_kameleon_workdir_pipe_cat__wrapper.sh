...
function post_exec_wrapper {
    ...
    # Print end flags
    echo -n __CMD_ERR_45_9874_112896_END__ 1>&2
    echo -n __CMD_OUT_45_9874_112896_END__
}

function pre_exec_wrapper {
    # Print begin flags
    echo -n __CMD_ERR_45_9874_112896_BEGIN__ 1>&2
    echo -n __CMD_OUT_45_9874_112896_BEGIN__
}
