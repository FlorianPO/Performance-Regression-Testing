...
function post_exec_wrapper {
    ...
    # Print end flags
    echo -n __CMD_ERR_43_6304_277148_END__ 1>&2
    echo -n __CMD_OUT_43_6304_277148_END__
}

function pre_exec_wrapper {
    # Print begin flags
    echo -n __CMD_ERR_43_6304_277148_BEGIN__ 1>&2
    echo -n __CMD_OUT_43_6304_277148_BEGIN__
}
