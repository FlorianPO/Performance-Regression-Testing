...
function post_exec_wrapper {
    ...
    # Print end flags
    echo -n __CMD_ERR_11_7127_224591_END__ 1>&2
    echo -n __CMD_OUT_11_7127_224591_END__
}

function pre_exec_wrapper {
    # Print begin flags
    echo -n __CMD_ERR_11_7127_224591_BEGIN__ 1>&2
    echo -n __CMD_OUT_11_7127_224591_BEGIN__
}
