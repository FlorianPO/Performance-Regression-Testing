...
function post_exec_wrapper {
    ...
    # Print end flags
    echo -n __CMD_ERR_11_9891_89498_END__ 1>&2
    echo -n __CMD_OUT_11_9891_89498_END__
}

function pre_exec_wrapper {
    # Print begin flags
    echo -n __CMD_ERR_11_9891_89498_BEGIN__ 1>&2
    echo -n __CMD_OUT_11_9891_89498_BEGIN__
}
