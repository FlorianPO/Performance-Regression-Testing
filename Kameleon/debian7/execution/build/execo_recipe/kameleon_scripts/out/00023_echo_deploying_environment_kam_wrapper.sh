...
function post_exec_wrapper {
    ...
    # Print end flags
    echo -n __CMD_ERR_23_7127_117521_END__ 1>&2
    echo -n __CMD_OUT_23_7127_117521_END__
}

function pre_exec_wrapper {
    # Print begin flags
    echo -n __CMD_ERR_23_7127_117521_BEGIN__ 1>&2
    echo -n __CMD_OUT_23_7127_117521_BEGIN__
}
