...
function post_exec_wrapper {
    ...
    # Print end flags
    echo -n __CMD_ERR_33_9874_264663_END__ 1>&2
    echo -n __CMD_OUT_33_9874_264663_END__
}

function pre_exec_wrapper {
    # Print begin flags
    echo -n __CMD_ERR_33_9874_264663_BEGIN__ 1>&2
    echo -n __CMD_OUT_33_9874_264663_BEGIN__
}
