...
function post_exec_wrapper {
    ...
    # Print end flags
    echo -n __CMD_ERR_33_4161_160347_END__ 1>&2
    echo -n __CMD_OUT_33_4161_160347_END__
}

function pre_exec_wrapper {
    # Print begin flags
    echo -n __CMD_ERR_33_4161_160347_BEGIN__ 1>&2
    echo -n __CMD_OUT_33_4161_160347_BEGIN__
}
