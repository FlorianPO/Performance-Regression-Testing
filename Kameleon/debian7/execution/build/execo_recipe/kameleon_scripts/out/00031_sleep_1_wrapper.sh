...
function post_exec_wrapper {
    ...
    # Print end flags
    echo -n __CMD_ERR_31_4161_22490_END__ 1>&2
    echo -n __CMD_OUT_31_4161_22490_END__
}

function pre_exec_wrapper {
    # Print begin flags
    echo -n __CMD_ERR_31_4161_22490_BEGIN__ 1>&2
    echo -n __CMD_OUT_31_4161_22490_BEGIN__
}
