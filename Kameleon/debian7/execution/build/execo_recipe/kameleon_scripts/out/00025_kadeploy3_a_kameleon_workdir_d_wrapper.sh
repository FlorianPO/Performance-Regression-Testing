...
function post_exec_wrapper {
    ...
    # Print end flags
    echo -n __CMD_ERR_25_7151_8779_END__ 1>&2
    echo -n __CMD_OUT_25_7151_8779_END__
}

function pre_exec_wrapper {
    # Print begin flags
    echo -n __CMD_ERR_25_7151_8779_BEGIN__ 1>&2
    echo -n __CMD_OUT_25_7151_8779_BEGIN__
}
