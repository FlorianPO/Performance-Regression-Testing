...
function post_exec_wrapper {
    ...
    # Print end flags
    echo -n __CMD_ERR_25_9891_522367_END__ 1>&2
    echo -n __CMD_OUT_25_9891_522367_END__
}

function pre_exec_wrapper {
    # Print begin flags
    echo -n __CMD_ERR_25_9891_522367_BEGIN__ 1>&2
    echo -n __CMD_OUT_25_9891_522367_BEGIN__
}
