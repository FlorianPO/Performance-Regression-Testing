...
function post_exec_wrapper {
    ...
    # Print end flags
    echo -n __CMD_ERR_69_9874_18879_END__ 1>&2
    echo -n __CMD_OUT_69_9874_18879_END__
}

function pre_exec_wrapper {
    # Print begin flags
    echo -n __CMD_ERR_69_9874_18879_BEGIN__ 1>&2
    echo -n __CMD_OUT_69_9874_18879_BEGIN__
}
