...
function post_exec_wrapper {
    ...
    # Print end flags
    echo -n __CMD_ERR_69_6065_80966_END__ 1>&2
    echo -n __CMD_OUT_69_6065_80966_END__
}

function pre_exec_wrapper {
    # Print begin flags
    echo -n __CMD_ERR_69_6065_80966_BEGIN__ 1>&2
    echo -n __CMD_OUT_69_6065_80966_BEGIN__
}
