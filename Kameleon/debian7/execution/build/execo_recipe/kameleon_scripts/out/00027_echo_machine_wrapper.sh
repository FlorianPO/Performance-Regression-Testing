...
function post_exec_wrapper {
    ...
    # Print end flags
    echo -n __CMD_ERR_27_4161_314771_END__ 1>&2
    echo -n __CMD_OUT_27_4161_314771_END__
}

function pre_exec_wrapper {
    # Print begin flags
    echo -n __CMD_ERR_27_4161_314771_BEGIN__ 1>&2
    echo -n __CMD_OUT_27_4161_314771_BEGIN__
}
