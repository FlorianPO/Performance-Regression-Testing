...
function post_exec_wrapper {
    ...
    # Print end flags
    echo -n __CMD_ERR_27_9891_628405_END__ 1>&2
    echo -n __CMD_OUT_27_9891_628405_END__
}

function pre_exec_wrapper {
    # Print begin flags
    echo -n __CMD_ERR_27_9891_628405_BEGIN__ 1>&2
    echo -n __CMD_OUT_27_9891_628405_BEGIN__
}
