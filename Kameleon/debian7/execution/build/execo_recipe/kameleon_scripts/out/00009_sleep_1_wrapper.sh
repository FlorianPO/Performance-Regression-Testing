...
function post_exec_wrapper {
    ...
    # Print end flags
    echo -n __CMD_ERR_9_9874_272948_END__ 1>&2
    echo -n __CMD_OUT_9_9874_272948_END__
}

function pre_exec_wrapper {
    # Print begin flags
    echo -n __CMD_ERR_9_9874_272948_BEGIN__ 1>&2
    echo -n __CMD_OUT_9_9874_272948_BEGIN__
}
