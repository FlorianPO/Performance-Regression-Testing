...
function post_exec_wrapper {
    ...
    # Print end flags
    echo -n __CMD_ERR_9_7402_457104_END__ 1>&2
    echo -n __CMD_OUT_9_7402_457104_END__
}

function pre_exec_wrapper {
    # Print begin flags
    echo -n __CMD_ERR_9_7402_457104_BEGIN__ 1>&2
    echo -n __CMD_OUT_9_7402_457104_BEGIN__
}
