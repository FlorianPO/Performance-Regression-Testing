...
function post_exec_wrapper {
    ...
    # Print end flags
    echo -n __CMD_ERR_17_9874_8917_END__ 1>&2
    echo -n __CMD_OUT_17_9874_8917_END__
}

function pre_exec_wrapper {
    # Print begin flags
    echo -n __CMD_ERR_17_9874_8917_BEGIN__ 1>&2
    echo -n __CMD_OUT_17_9874_8917_BEGIN__
}
