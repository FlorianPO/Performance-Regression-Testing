...
function post_exec_wrapper {
    ...
    # Print end flags
    echo -n __CMD_ERR_17_9891_491998_END__ 1>&2
    echo -n __CMD_OUT_17_9891_491998_END__
}

function pre_exec_wrapper {
    # Print begin flags
    echo -n __CMD_ERR_17_9891_491998_BEGIN__ 1>&2
    echo -n __CMD_OUT_17_9891_491998_BEGIN__
}
