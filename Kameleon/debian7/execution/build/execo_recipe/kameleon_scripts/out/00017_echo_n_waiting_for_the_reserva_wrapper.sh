...
function post_exec_wrapper {
    ...
    # Print end flags
    echo -n __CMD_ERR_17_7402_64265_END__ 1>&2
    echo -n __CMD_OUT_17_7402_64265_END__
}

function pre_exec_wrapper {
    # Print begin flags
    echo -n __CMD_ERR_17_7402_64265_BEGIN__ 1>&2
    echo -n __CMD_OUT_17_7402_64265_BEGIN__
}
