...
function post_exec_wrapper {
    ...
    # Print end flags
    echo -n __CMD_ERR_7_3459_80511_END__ 1>&2
    echo -n __CMD_OUT_7_3459_80511_END__
}

function pre_exec_wrapper {
    # Print begin flags
    echo -n __CMD_ERR_7_3459_80511_BEGIN__ 1>&2
    echo -n __CMD_OUT_7_3459_80511_BEGIN__
}
