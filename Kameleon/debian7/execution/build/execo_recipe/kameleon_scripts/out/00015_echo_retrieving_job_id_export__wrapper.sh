...
function post_exec_wrapper {
    ...
    # Print end flags
    echo -n __CMD_ERR_15_7127_14649_END__ 1>&2
    echo -n __CMD_OUT_15_7127_14649_END__
}

function pre_exec_wrapper {
    # Print begin flags
    echo -n __CMD_ERR_15_7127_14649_BEGIN__ 1>&2
    echo -n __CMD_OUT_15_7127_14649_BEGIN__
}
