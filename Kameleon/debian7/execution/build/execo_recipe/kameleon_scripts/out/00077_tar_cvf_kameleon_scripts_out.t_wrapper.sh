...
function post_exec_wrapper {
    ...
    # Print end flags
    echo -n __CMD_ERR_77_7402_754618_END__ 1>&2
    echo -n __CMD_OUT_77_7402_754618_END__
}

function pre_exec_wrapper {
    # Print begin flags
    echo -n __CMD_ERR_77_7402_754618_BEGIN__ 1>&2
    echo -n __CMD_OUT_77_7402_754618_BEGIN__
}
