...
function post_exec_wrapper {
    ...
    # Print end flags
    echo -n __CMD_ERR_57_7402_36922_END__ 1>&2
    echo -n __CMD_OUT_57_7402_36922_END__
}

function pre_exec_wrapper {
    # Print begin flags
    echo -n __CMD_ERR_57_7402_36922_BEGIN__ 1>&2
    echo -n __CMD_OUT_57_7402_36922_BEGIN__
}
