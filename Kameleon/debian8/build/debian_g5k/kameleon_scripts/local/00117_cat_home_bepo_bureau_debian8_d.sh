...
# Log cmd
echo cat\ /home/bepo/Bureau/debian8/default/chroot/steps/data/skel/.pythonrc.py >> "${__ROOT_DIRECTORY__}/bash_history"



cat /home/bepo/Bureau/debian8/default/chroot/steps/data/skel/.pythonrc.py
