...
function post_exec_wrapper {
    ...
    # Print end flags
    echo -n __CMD_ERR_111_4924_494586_END__ 1>&2
    echo -n __CMD_OUT_111_4924_494586_END__
}

function pre_exec_wrapper {
    # Print begin flags
    echo -n __CMD_ERR_111_4924_494586_BEGIN__ 1>&2
    echo -n __CMD_OUT_111_4924_494586_BEGIN__
}
