...
function post_exec_wrapper {
    ...
    # Print end flags
    echo -n __CMD_ERR_93_9689_3831_END__ 1>&2
    echo -n __CMD_OUT_93_9689_3831_END__
}

function pre_exec_wrapper {
    # Print begin flags
    echo -n __CMD_ERR_93_9689_3831_BEGIN__ 1>&2
    echo -n __CMD_OUT_93_9689_3831_BEGIN__
}
