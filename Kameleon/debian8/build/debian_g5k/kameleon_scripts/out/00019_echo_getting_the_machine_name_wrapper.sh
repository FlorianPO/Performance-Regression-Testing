...
function post_exec_wrapper {
    ...
    # Print end flags
    echo -n __CMD_ERR_19_3377_838908_END__ 1>&2
    echo -n __CMD_OUT_19_3377_838908_END__
}

function pre_exec_wrapper {
    # Print begin flags
    echo -n __CMD_ERR_19_3377_838908_BEGIN__ 1>&2
    echo -n __CMD_OUT_19_3377_838908_BEGIN__
}
