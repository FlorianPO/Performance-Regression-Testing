...
function post_exec_wrapper {
    ...
    # Print end flags
    echo -n __CMD_ERR_15_3377_435007_END__ 1>&2
    echo -n __CMD_OUT_15_3377_435007_END__
}

function pre_exec_wrapper {
    # Print begin flags
    echo -n __CMD_ERR_15_3377_435007_BEGIN__ 1>&2
    echo -n __CMD_OUT_15_3377_435007_BEGIN__
}
