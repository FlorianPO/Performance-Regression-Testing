...
function post_exec_wrapper {
    ...
    # Print end flags
    echo -n __CMD_ERR_23_3377_17486_END__ 1>&2
    echo -n __CMD_OUT_23_3377_17486_END__
}

function pre_exec_wrapper {
    # Print begin flags
    echo -n __CMD_ERR_23_3377_17486_BEGIN__ 1>&2
    echo -n __CMD_OUT_23_3377_17486_BEGIN__
}
