...
# Log cmd
echo cat\ \$\{KAMELEON_WORKDIR\}/pipe-cat_home_bepo_bureau_\ \|\ cat\ \>/home/bepo/Bureau/debian8/execution/build/execo/g5k_machine\ \&\&\ rm\ \$\{KAMELEON_WORKDIR\}/pipe-cat_home_bepo_bureau_ >> "${__ROOT_DIRECTORY__}/bash_history"
