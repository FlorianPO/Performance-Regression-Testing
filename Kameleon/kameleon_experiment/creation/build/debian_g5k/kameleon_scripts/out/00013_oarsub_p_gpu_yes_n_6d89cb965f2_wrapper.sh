...
function post_exec_wrapper {
    ...
    # Print end flags
    echo -n __CMD_ERR_13_6059_118512_END__ 1>&2
    echo -n __CMD_OUT_13_6059_118512_END__
}

function pre_exec_wrapper {
    # Print begin flags
    echo -n __CMD_ERR_13_6059_118512_BEGIN__ 1>&2
    echo -n __CMD_OUT_13_6059_118512_BEGIN__
}
