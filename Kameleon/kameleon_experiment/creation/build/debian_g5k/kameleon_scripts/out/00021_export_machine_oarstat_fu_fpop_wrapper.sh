...
function post_exec_wrapper {
    ...
    # Print end flags
    echo -n __CMD_ERR_21_6059_272996_END__ 1>&2
    echo -n __CMD_OUT_21_6059_272996_END__
}

function pre_exec_wrapper {
    # Print begin flags
    echo -n __CMD_ERR_21_6059_272996_BEGIN__ 1>&2
    echo -n __CMD_OUT_21_6059_272996_BEGIN__
}
