...
function post_exec_wrapper {
    ...
    # Print end flags
    echo -n __CMD_ERR_25_6059_43211_END__ 1>&2
    echo -n __CMD_OUT_25_6059_43211_END__
}

function pre_exec_wrapper {
    # Print begin flags
    echo -n __CMD_ERR_25_6059_43211_BEGIN__ 1>&2
    echo -n __CMD_OUT_25_6059_43211_BEGIN__
}
